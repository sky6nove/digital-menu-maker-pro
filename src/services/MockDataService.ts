...
let categories: Category[] = [
  { id: 1, name: "Hamburguers Simples", isActive: true },
  { id: 2, name: "Hamburguers Especiais", isActive: true },
  { id: 3, name: "Acompanhamentos", isActive: true },
  { id: 4, name: "Bebidas", isActive: true },
];
